...
public class KpiCategoryTargetDaysRequest {
	
	private Integer millId;
	private Integer buId; 
	private Integer kpiCategoryId; 
	private Integer noOfTargetDays;
	...
	public Integer getNoOfTargetDays() {
		return noOfTargetDays;
	}
	public void setNoOfTargetDays(Integer noOfTargetDays) {
		this.noOfTargetDays = noOfTargetDays;
	}
}
