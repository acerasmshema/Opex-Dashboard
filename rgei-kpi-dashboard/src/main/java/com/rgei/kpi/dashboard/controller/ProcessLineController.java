...
public class ProcessLineController {
	...
	public ResponseEntity<TargetProceessLine> getAnnualProcessLineV2(@RequestHeader(value = "millId") String millId,
		...
		TargetProceessLine response = processLinePulpKpiService.getAnnualExtendedProcessLine(millId, buId,
				kpiCategoryId, kpiId);
		return new ResponseEntity<>(response, HttpStatus.OK);
	}
	...
	public ResponseEntity<TargetProceessLine> getAnnualTargetProcessLine(@RequestHeader(value = "millId") String millId,
		...
		TargetProceessLine response = processLinePulpKpiService.getAnnualTargetProcessLine(millId, buId, kpiCategoryId,
				kpiId);
		return new ResponseEntity<>(response, HttpStatus.OK);
	}
	...
	public ResponseEntity<ProcessLineProjectedResponse> getProjecctedTargetDetails(
			@RequestHeader(value = "millId") String millId, @RequestHeader(value = "buId") String buId,
			@RequestHeader(value = "kpiCategoryId") String kpiCategoryId,
			@RequestHeader(value = "kpiId") String kpiId) {
		...
		ProcessLineProjectedResponse processLineProjectedResponse = processLinePulpKpiService
				.getProjectedProcessLineDetails(millId, buId, kpiCategoryId, kpiId);
