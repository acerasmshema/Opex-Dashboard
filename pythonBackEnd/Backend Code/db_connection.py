...
class DB_connection(object):
    ...
    def create_krc_pulp_pi_table(self,table_name):
        ...
        self.pi_data = Table(table_name, self.metadata,
                             ...
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0221:afc".lower())),Float()),
                             ...
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0251:afc".lower())),Float()),
                             # Monthly
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0252:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0254:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0256:afc".lower())),Float()),
                             ...
                             # Monthly Consumption
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0207:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0226:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0228:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0230:afc".lower())),Float()),
                             ...
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0243:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0245:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0247:afc".lower())),Float()),
                             ...
                             # monthly
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0234:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0236:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0238:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0240:afc".lower())),Float()),
                             ...
                             # monthly
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0261:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0263:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0265:afc".lower())),Float()),
                             ...
                             # monthly
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0317:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0319:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0321:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0323:afc".lower())),Float()),
                             ...
                             # monthly
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0271:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0273:afc".lower())),Float()),
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0275:afc".lower())),Float()),
                             ...
                             Column(re.sub('[^0-9a-zA-Z]+', '_', "tag_{}".format("RPL.111XC0219:afc".lower())),Float()),
    ...
    def create_daily_kpi_pulp_table(self, table_name):
        ...
        self.pi_data = Table(table_name, self.metadata,
                             ...
                             Column('process_line_1_m',Float()),
                             Column('process_line_2_m',Float()),
                             Column('process_line_3_m',Float()),
                             Column('process_line_4_m', Float()),
