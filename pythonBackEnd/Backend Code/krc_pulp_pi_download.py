...
production_tags = ["RPL.111XC0003:afc","RPL.111XC0002:afc","RPL.433FQ1260.F:Y_DAY", #FL1,2,3
                   "RPL.422YI5139-YD:value","RPL.111XC0221:afc" ,
                   "RPL.111XC0005:afc","RPL.111XC0006:afc","RPL.111XC0007:afc","RPL.111XC0008:afc"]

clo2_consumption_tags = ["RPL.111XC0017:afc","RPL.111XC0023:afc",
                         "RPL.111XC0018:afc","RPL.111XC0024:afc",
                         "RPL.111XC0019:afc","RPL.111XC0025:afc",
                         "RPL.111XC0251:afc"]
clo2_consumption_tags_mth = ["RPL.111XC0252:afc","RPL.111XC0254:afc","RPL.111XC0256:afc"]
defoamer_tags = ['RPL.111XC0170:afc','RPL.111XC0171:afc','RPL.111XC0172:afc','RPL.111XC0173:afc','RPL.111XC0202:afc']

h2o2_consumption_tags = ["RPL.111XC0020:afc","RPL.111XC0021:afc", "RPL.111XC0022:afc","RPL.111XC0194:afc",
                         "RPL.111XC0207:afc"] #FL1,2,3
h2o2_consumption_tags_mth=["RPL.111XC0226:afc","RPL.111XC0228:afc","RPL.111XC0230:afc"]
...
naoh_total_tags_mth=["RPL.111XC0243:afc","RPL.111XC0245:afc","RPL.111XC0247:afc"]
...
white_liqour_consumptions_tags_mth= ["RPL.111XC0234:afc","RPL.111XC0236:afc","RPL.111XC0238:afc","RPL.111XC0240:afc"]
...
utility_power_consumption_mth=["RPL.111XC0261:afc","RPL.111XC0263:afc","RPL.111XC0265:afc"]
...
total_steam_consumption_tags_mth=["RPL.111XC0317:afc","RPL.111XC0319:afc","RPL.111XC0321:afc","RPL.111XC0323:afc"]
...
water_consumption_mth = ["RPL.111XC0271:afc","RPL.111XC0273:afc","RPL.111XC0275:afc"]

wc_woodchip_total =['RPL.111XC0220:afc']
wc_chip_meter_avg = ["RPL.111XC0048:afc"] #FL3
wc_consumption=['RPL.111XC0211:afc','RPL.111XC0213:afc','RPL.111XC0215:afc','RPL.111XC0217:afc','RPL.111XC0219:afc']
...
pulp_pi_tags += clo2_consumption_tags_mth
pulp_pi_tags += defoamer_tags
pulp_pi_tags += h2o2_consumption_tags
pulp_pi_tags += h2o2_consumption_tags_mth
...
pulp_pi_tags += water_consumption_mth
...
try:
    ...
    print('DB Connection successful!! HD ')
except:
...
try:
    ...
    kpi_info_columns = ['datetime','country_id','mill_id','bu_id','bu_type_id','kpi_category_id','kpi_id',
                        ...
                        'process_line_1_m','process_line_2_m','process_line_3_m','process_line_4_m'
                        ]
